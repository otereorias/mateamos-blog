    ...
    return (
      <Html lang="en">
        ...
        <body className="antialiased text-black bg-white dark:bg-gray-900 dark:text-white">
          <Main />
          <NextScript />
          <script data-ad-client="ca-pub-1276449606214118" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
          <script
            src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1276449606214118"
            async
            crossorigin="anonymous">
          </script>
        </body>
